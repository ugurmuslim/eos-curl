...
$ch = curl_init('http://127.0.0.1:8888/v1/chain/abi_json_to_bin');
...
// set url
curl_setopt($ch, CURLOPT_URL, "localhost:8888/v1/chain/get_info");
...
// Prepare new cURL resource
$ch = curl_init('localhost:8888/v1/chain/get_block');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLINFO_HEADER_OUT, true);
curl_setopt($ch, CURLOPT_POST, true);
curl_setopt($ch, CURLOPT_POSTFIELDS, $payload);
...
// Prepare new cURL resource
$ch = curl_init('http://127.0.0.1:8888/v1/chain/get_required_keys');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLINFO_HEADER_OUT, true);
curl_setopt($ch, CURLOPT_POST, true);
curl_setopt($ch, CURLOPT_POSTFIELDS, $payload);
...
// Prepare new cURL resource
$ch = curl_init('http://127.0.0.1:8888/v1/chain/push_transaction');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLINFO_HEADER_OUT, true);
curl_setopt($ch, CURLOPT_POST, true);
curl_setopt($ch, CURLOPT_POSTFIELDS, $payload);
